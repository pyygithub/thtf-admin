...
import com.thtf.common.core.utils.IdGenerator;
import com.thtf.flowable.mapper.FlowableHisActinstMapper;
import com.thtf.flowable.mapper.FlowableRunActinstMapper;
...
public abstract class BaseProcessService {
    ...
    @Autowired
    private FlowableRunActinstMapper flowableRunActinstMapper;
    @Autowired
    private FlowableHisActinstMapper flowableHisActinstMapper;
    ...
    protected void deleteActivity(String disActivityId, String processInstanceId) {
        ...
        if (CollectionUtils.isNotEmpty(disActivities)) {
            ...
            if (CollectionUtils.isNotEmpty(datas)) {
                ...
                flowableRunActinstMapper.deleteRunActinstsByIds(runActivityIds);
                flowableHisActinstMapper.deleteHisActinstsByIds(runActivityIds);
            }
        }
    }
    ...
    protected TaskEntity createSubTask(TaskEntity ptask, String ptaskId, String assignee) {
        ...
        if (ptask != null) {
            //1.生成子任务
            task = (TaskEntity) taskService.newTask(idGenerator.snowflakeId() + "");
